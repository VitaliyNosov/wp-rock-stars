      ...
      <div class="col-md-4">
        <div class="fh5co-pricing to-animate">
          <div class="price-wrap text-center">
            ...
            <ul>
              <li><i class="icon-check"></i> Unlimited Projects</li>
              <li><i class="icon-check"></i> 24/7 Support</li>
              <li><i class="icon-check"></i> Mobile Friendly</li>
              <li><i class="icon-check"></i> Free Templates</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <form action="#" method="post" class="form-contact to-animate">
